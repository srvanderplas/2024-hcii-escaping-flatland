...
\hypersetup{
  ...
  pdfkeywords={teaching, graphics, user-study},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
in introductory classes as experiential learning activities.
  \keywords{ teaching  \and  graphics  \and  user-study }
\end{abstract}
...
\includegraphics{image/CM1984Fig4.png}
...
\includegraphics{image/design.png}
...
\includegraphics{image/03-Practice-2.png}
...
\includegraphics{image/05-Experiment-01-filled-in.png}
...
\includegraphics{index_files/figure-pdf/fig-violin-accuracy-1.pdf}
