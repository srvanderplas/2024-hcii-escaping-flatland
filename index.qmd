...
Examining the charts, it seems that the values used were 17.8, 26.1, 38.3, 46.4 (twice), 56.2, 68.1 (twice), and 82.5 (twice). 
...
Bar3D("stimuli/stl_files/id-04-Type1-Rep01.stl", color = "#DD1F31")
par3d(params)
