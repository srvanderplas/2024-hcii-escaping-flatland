...
abstract: |
    Almost 40 years ago, @clevelandGraphicalPerceptionTheory1984 published the first of 3 papers detailing experiments assessing the accuracy of numerical perception using different types of charts. 
    ...
    In this paper, we present several experiments which replicate the bar chart portion of Cleveland & McGill's original study, comparing 2D, 3D fixed perspective, 3D rendered, and 3D printed charts.
